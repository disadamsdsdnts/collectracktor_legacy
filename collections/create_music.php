<?php
    ...
    if(isset($_POST['submitButton'])){
        ...
        $collectionImage = 'img/0_music.jpg';
        $login = $_SESSION['login'];

        $query = "INSERT INTO $tableCollections (ID, Name, Description, Image, Category, UsersLogin) VALUES (NULL, '$collectionName', '$collectionDesc', '$collectionImage', 'music', '$login')";
...
<html>
<head>
	<title>Crear colección de música</title>
</head>
...
<body>
    ...
    <form method="POST" action="create_music.php" id="formCreator" enctype="multipart/form-data">
        <div class="row card justify-content-center">
            <div class="card-header">

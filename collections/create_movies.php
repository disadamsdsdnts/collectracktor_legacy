<?php
    ...
    if(isset($_POST['submitButton'])){
        ...
        $collectionImage = 'img/0_movies.jpg';
        $login = $_SESSION['login'];

        $query = "INSERT INTO $tableCollections (ID, Name, Description, Image, Category, UsersLogin) VALUES (NULL, '$collectionName', '$collectionDesc', '$collectionImage', 'movies', '$login')";
...
<html>
<head>
	<title>Crear una colección de películas</title>
</head>
...
<body>
    ...
    <div class="row justify-content-center">
    	<h1>
    		🎬 Crea una colección de películas 🎬
    	</h1>
    </div>
    ...
    <form method="POST" action="create_movies.php" id="formCreator" enctype="multipart/form-data">
        <div class="row card justify-content-center">
            <div class="card-header">
